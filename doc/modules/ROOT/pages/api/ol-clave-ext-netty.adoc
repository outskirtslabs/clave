...
See <<server-options,`server-options`>> to install the returned context into Aleph.

[.api-source]
link:https://github.com/outskirtslabs/clave/blob/main/src/ol/clave/ext/netty.clj#L195-L259[source,window=_blank]
...
xref:api/ol-clave-ext-aleph.adoc#start-server[`ol.clave.ext.aleph/start-server`] wires this together for you.

[.api-source]
link:https://github.com/outskirtslabs/clave/blob/main/src/ol/clave/ext/netty.clj#L281-L311[source,window=_blank]
