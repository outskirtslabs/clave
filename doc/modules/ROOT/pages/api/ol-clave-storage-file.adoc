...
Returns a record implementing xref:api/ol-clave-storage.adoc#Storage[`ol.clave.storage/Storage`] and
xref:api/ol-clave-storage.adoc#TryLocker[`ol.clave.storage/TryLocker`].
...
[.api-source]
link:https://github.com/outskirtslabs/clave/blob/main/src/ol/clave/storage/file.clj#L654-L692[source,window=_blank]
